...
public class BotBotMessageServiceImpl implements BotMessageService {
            ...
            if (targetChatId != null) {
                ...
                SendResponse response = telegramBot.execute(
                        new SendMessage(
                                ...
                                .parseMode(ParseMode.HTML)
                                .replyMarkup(buttonService.blockIncUserBtn(session.getChatId()))
                );
                sessionService.updateSessionState(session.getChatId(), State.MENU);
                messageService.saveMessage(targetChatId, response.message().messageId(), session.getChatId(), message.messageId(), message.text());
            } else {
